 ...
 *  5. El historial de la franja: episodios previos, sus veredictos humanos
 *     y patrones recurrentes (mismo sensor/corredor en varios episodios).
 *
 ...
 *  - DESCRIBE física y secuencia ("el pH salió de su banda 6.5–7.5, después
...
export const EVENT_NARRATIVES: Record<number, string[]> = {
  18: [
    'Tenemos un **episodio activo** en el corredor químico→ultrafiltración. La primera señal fue el **pH de la dosificación de HCl (AIT202)**, que está leyendo fuera de su banda normal de 6.5–7.5; poco después empezó a desviarse el **nivel del tanque T-301 (LIT301)** y ahora la **presión diferencial de la membrana (DPIT301)** trabaja por encima de su referencia de 0.4 bar.',
  ...
  14: [
    '**Tres minutos y medio con la captación completa fuera de régimen**: el nivel del tanque T-101 fuera de su banda de 500–820 mm, el **caudal de entrada (FIT101) sin correspondencia con la posición de la válvula MV101**, y la bomba P101 con un estado incoherente con la demanda.',
  ...
  13: [
    ...
    'Comparte firma con los episodios del corredor químico de esta semana: ese par de señales ha sido el **preludio habitual** antes de los eventos largos.',
  ],
  12: [
  ...
  11: [
    ...
    'Nivel **CRITICAL sostenido** durante toda la racha y cinco puntos de medida implicados. Es el mismo corredor pH→T-301 que reaparece en episodios posteriores — el patrón de referencia de esta semana.',
  ],
  10: [
  ...
  9: [
    'Dos minutos con el **caudal de ultrafiltración (FIT301)** fuera de su banda de 1.5–2.5 m³/h y el **nivel del T-301 reaccionando a continuación** — coherencia hidráulica entre ambas señales, que es lo que da credibilidad al evento.',
  ],
  8: [
  ...
  7: [
    'Tres minutos con la **etapa de ultrafiltración completa desviada**: nivel del T-301, presión de membrana y el conjunto bomba–válvula de retrolavado. La secuencia arrancó por el nivel y acabó afectando a los **cuatro puntos de medida de la etapa**.',
  ],
  6: [
  ...
  4: [
    'Minuto y medio en la **captación**: el caudal de entrada (**FIT101**) cayó por debajo de su banda de 2–3 m³/h mientras el **nivel del T-101 subía en respuesta** — física coherente entre ambas señales.',
...
/**
 * Narrativa por ventana preset (resumen de franja, voz de relevo de turno).
...
export const RANGE_NARRATIVES: Partial<Record<AnomalyEventRange, RangeNarrative>> = {
  '24h': {
    paragraphs: [
      ...
      'El segundo frente es el **corredor químico→ultrafiltración**: el episodio **#16** (pH de HCl fuera de banda, cloro reaccionando, T-301 y MV201 arrastrados) y, ahora mismo, el **#18 EN CURSO con la misma firma** — misma entrada por pH, misma propagación aguas abajo.',
      'El resto fueron **tres transitorios breves** (presión de membrana, caudal a UV/RO y el par conductividad–pH) sin continuidad — dos ya descartados, uno pendiente.',
    ],
    lookFirst:
  ...
  yesterday: {
    paragraphs: [
      ...
      'A última hora pudo registrarse además un transitorio breve del par **conductividad–pH (#13)** en la etapa química; esa firma reaparece en los episodios largos de la semana.',
    ],
    lookFirst: 'Nada urgente; el transitorio **#13** sigue sin veredicto.',
  },
  '7d': {
    paragraphs: [
      'La semana deja **once registros** y una historia clara: el **corredor químico→ultrafiltración es el foco dominante**. El episodio de referencia es el **#11** — cinco minutos con la cadena completa fuera de régimen, desde el pH de la dosificación hasta la presión de membrana, confirmado como real — y su firma (entrada por **AIT202**, arrastre hacia **T-301**) reaparece en el #16 y en el episodio activo #18.',
      'Fuera de ese corredor: un episodio serio y confirmado en la **captación (#14)**, otro real en el **caudal de UF (#9)**, y el **#8 en decloración quedó cerrado administrativamente** por un reinicio del servicio — su duración real es desconocida y sigue sin veredicto.',
